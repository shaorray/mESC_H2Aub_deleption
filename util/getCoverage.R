...
covMatrix <- function(intervals, input_cov, bin_width, new_len, df = 20)
{ # Args:
  ...
  out_matrix <- foreach( chr = .seqnames, .combine = rbind ) %dopar%
    {
...
.countBW <- function(bw_files, intervals, blacklist = NULL, fast = F)
{ # Args:

fetch_TU_feature <- function(TU.gr, is.fast = T) {
  ...
  TSS.gr <- promoters(TU.gr, upstream = 1000, downstream = 1000)
  ...
  # Pasini
  TU_feature_table$PCGF2_Pasini <- .countBW("/mnt/0E471D453D8EE463/GEO_bw/Ring1b_CKO/2020_Tamburri_PARETA-PCGF2.mm9.bw",
                                          TU.gr, fast = is.fast) %>% unlist() %>% unname()
  TU_feature_table$JARID2_Pasini <- .countBW("/mnt/0E471D453D8EE463/GEO_bw/Ring1b_CKO/2020_Tamburri_PARETA-JARID2.mm9.bw",
                                            TU.gr, fast = is.fast) %>% unlist() %>% unname()
  TU_feature_table$MTF2_Pasini <- .countBW("/mnt/0E471D453D8EE463/GEO_bw/Ring1b_CKO/2020_Tamburri_PARETA-MTF2.mm9.bw",
                                            TU.gr, fast = is.fast) %>% unlist() %>% unname()
  TU_feature_table$RING1B_Pasini <- .countBW("/mnt/0E471D453D8EE463/GEO_bw/Ring1b_CKO/2020_Tamburri_PARETA-RING1B.mm9.bw",
                                           TU.gr, fast = is.fast) %>% unlist() %>% unname()
  
  # Klose
  TU_feature_table$RING1B_Klose <- .countBW(list.files("/mnt/0E471D453D8EE463/GEO_bw/Ring1b_CKO/2020_Blackledge/", 
                                                       pattern = "PRC1CPM_UNT_RING1B", full.names = T), 
                                   TSS.gr, fast = is.fast) %>% rowMeans() %>% 
                                    unlist() %>% unname()
  TU_feature_table$SUZ12_Klose <- .countBW(list.files("/mnt/0E471D453D8EE463/GEO_bw/Ring1b_CKO/2020_Blackledge", 
                                                       pattern = "PRC1CPM_UNT_SUZ12", full.names = T), 
                                            TSS.gr, fast = is.fast) %>% rowMeans() %>% 
                                    unlist() %>% unname()
  TU_feature_table$PCGF6_Klose <- .countBW(list.files("/mnt/0E471D453D8EE463/GEO_bw/Ring1b_CKO/2020_Blackledge", 
                                                      pattern = "PRC1CPM_UNT_PCGF6", full.names = T), 
                                           TSS.gr, fast = is.fast) %>% rowMeans() %>% 
                                    unlist() %>% unname()
  TU_feature_table$PCL2_Klose <- .countBW(list.files("/mnt/0E471D453D8EE463/GEO_bw/Ring1b_CKO/2020_Blackledge", 
                                                      pattern = "PRC1CPM_UNT_PCL2", full.names = T), 
                                           TSS.gr, fast = is.fast) %>% 
                                    rowMeans() %>% unlist() %>% unname()
  TU_feature_table$PCGF2_Klose <- .countBW(list.files("/mnt/0E471D453D8EE463/GEO_bw/Ring1b_CKO/2020_Blackledge", 
                                                     pattern = "PRC1CPM_UNT_PCGF2", full.names = T), 
                                          TSS.gr, fast = is.fast) %>% 
                                    rowMeans() %>% unlist() %>% unname()
  TU_feature_table$PCGF1_Klose <- .countBW(list.files("/mnt/0E471D453D8EE463/GEO_bw/Ring1b_CKO/2020_Blackledge", 
                                                     pattern = "PRC1CPM_UNT_PCGF1", full.names = T), 
                                          TSS.gr, fast = is.fast) %>% 
                                    rowMeans() %>% unlist() %>% unname()
  TU_feature_table$JARID2_Klose <- .countBW(list.files("/mnt/0E471D453D8EE463/GEO_bw/Ring1b_CKO/2020_Blackledge", 
                                                      pattern = "PRC1CPM_UNT_JARID2", full.names = T), 
                                           TSS.gr, fast = is.fast) %>% 
                                    rowMeans() %>% unlist() %>% unname()
  TU_feature_table$H3K27me3_Klose <- .countBW(list.files("/mnt/0E471D453D8EE463/GEO_bw/Ring1b_CKO/2020_Blackledge", 
                                                       pattern = "PRC1CPM_UNT_H3K27me3", full.names = T), 
                                            TSS.gr, fast = is.fast) %>% 
                                    rowMeans() %>% unlist() %>% unname()
  TU_feature_table$H2AK119ub1_Klose <- .countBW(list.files("/mnt/0E471D453D8EE463/GEO_bw/Ring1b_CKO/2020_Blackledge", 
                                                       pattern = "PRC1CPM_UNT_H2AK119ub1", full.names = T), 
                                            TSS.gr, fast = is.fast) %>% 
                                    rowMeans() %>% unlist() %>% unname()
  TU_feature_table$EPOP_Klose <- .countBW(list.files("/mnt/0E471D453D8EE463/GEO_bw/Ring1b_CKO/2020_Blackledge", 
                                                           pattern = "PRC1CPM_UNT_EPOP", full.names = T), 
                                                TSS.gr, fast = is.fast) %>% 
                                    rowMeans() %>% unlist() %>% unname()
  TU_feature_table$AEBP2_Klose <- .countBW(list.files("/mnt/0E471D453D8EE463/GEO_bw/Ring1b_CKO/2020_Blackledge", 
                                                           pattern = "PRC1CPM_UNT_AEBP2", full.names = T), 
                                                TSS.gr, fast = is.fast) %>% 
                                    rowMeans() %>% unlist() %>% unname()
